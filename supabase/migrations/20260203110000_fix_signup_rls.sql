-- Migration: Fix signup provisioning with RLS
-- Date: 2026-02-03
-- Purpose: Allow auth signup provisioning functions to bypass RLS safely

-- ============================================================================
-- 1. Update create_client_on_signup to bypass RLS within definer context
-- ============================================================================
...
DECLARE
    ...
    v_domain TEXT;
BEGIN
    -- Ensure RLS does not block provisioning
...
-- ============================================================================
-- 2. Update sync_client_on_user_update to bypass RLS within definer context
-- ============================================================================
