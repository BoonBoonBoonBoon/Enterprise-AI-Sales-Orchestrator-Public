...
1. **Ensure Redis is accessible**:
   ...
   REDIS_URL=redis://default:***@your-redis-host.redns.redis-cloud.com:6379/0
...
redis-cli -h your-redis-host.c335.europe-west2-1.gce.redns.redis-cloud.com -p 15143 -a PASSWORD
