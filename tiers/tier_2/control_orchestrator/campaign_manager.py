"""Campaign Manager - High-level control plane for orchestration.

Schedules triggers, manages campaigns, and issues orchestration commands.
This class subsumes a lightweight dispatcher: schedule/run/cancel flows and gate delivery.
"""
from typing import Any, Dict, Optional
from datetime import datetime, timezone
from tiers.tier_2.registry import Registry
from tiers.tier_2.base_orchestrator import BaseOrchestrator


class CampaignManager:
    """High-level control plane that schedules triggers, manages campaigns,
    and issues orchestration commands.
    """
