...
from services.persistence.adapters.in_memory_adapter import InMemoryAdapter  # re-export for convenience
...
def build_supabase_service() -> PersistenceService:
    ...
    from services.persistence.adapters.supabase_adapter import SupabaseAdapter  # local import to avoid heavy deps at module import
